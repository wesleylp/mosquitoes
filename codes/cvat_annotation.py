...
class CVATAnnotation(Annotation):
    def __init__(self, annotation_path=None, total_frames=None, width_height=None, encoding='utf8'):
...
if __name__ == "__main__":
    ...
    annot_image = CVATAnnotationImage(
        1740, '/home/wesley.passos/repos/mosquitoes-wes/data/v1.0/annotation/deleteme.xml')
